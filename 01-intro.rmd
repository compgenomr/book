...
```{r,chromatinChr,fig.cap="Chromosome structure in animals",fig.align = 'center',out.width='100%',echo=FALSE}
knitr::include_graphics("genomicsIntro_data/nonR_figures/chromatinChr.png" )
```
...
knitr::include_graphics("genomicsIntro_data/nonR_figures/CentDogma.png" )
```
...
```{r,RealGene,fig.cap="A) Representation of a gene at UCSC browser. Boxes indicate exons, and lines indicate introns. B) Partial sequence of FATE1 gene as shown in NCBI GenBank database.",fig.align = 'center',out.width='100%',ref.label='RealGene',echo=FALSE}
 
knitr::include_graphics("genomicsIntro_data/nonR_figures/RealGene.png" )
```
...
```{r,regSummary,fig.cap="Representation of regulatory regions in animal genomes",fig.align = 'center',out.width='100%',ref.label='regSummary',echo=FALSE}
 
knitr::include_graphics("genomicsIntro_data/nonR_figures/regulationSummary.png" )
```
...
<div class="rmdnote">
__Want to know more on transcriptional regulation ?__
...
(PARs) and small nucleolar RNAs (snoRNAs). lncRNAs are typically >200 bp long,
...
__Want to know more on post-transcriptional regulation...__
...
http://www.nature.com/nrg/journal/v15/n9/abs/nrg3765.html
...
is imperfect DNA repair. Every day any human cell suffers multiple instances DNA damage.
...
```{r,HTassays,fig.cap="Common steps of High-throughput assays in genome biology",fig.align = 'center',out.width='100%',ref.label='HTassays',echo=FALSE}
knitr::include_graphics("genomicsIntro_data/nonR_figures/HTassays.png" )
```
...
on the sequencing protocol different strategies are applied for analysis. 
Some of the potential analysis strategies and processed output of read alignments
...
```{r,HTseq,fig.cap="High-throughput sequencing summary",fig.align = 'center',out.width='100%',ref.label='HTseq',echo=FALSE}
knitr::include_graphics("genomicsIntro_data/nonR_figures/HTseq.png" )
```
...
experiment. However, there is a lot variation between the same type of cells,
this variation is not observed at all. Newer sequecing techniques can work 
...
__Want to know more on high-throughput sequencing?__

- Current and the future high-throughput sequencing technologies
http://www.sciencedirect.com/science/article/pii/S1097276515003408

- Illumina repository for different library preperation protocols for sequencing
  http://www.illumina.com/techniques/sequencing/ngs-library-prep/library-prep-methods.html
</div>
...
research projects from either individual labs or consortiums that 
produce petabytes of auxiliary genomics data, such as ChIP-seq, RNA-seq, etc. 

There are two requirements for to be able to visualize genomes and its associated
...
. The more the organism is
worked on the more auxiliary data you will have.
...
that can be used in connection with the browser. One of the most useful tool 
is _UCSC Table Browser_, which lets you download the all the data you see on the 
...
from multiple species and it also comes with auxiliary data. Ensemlb is 
associated with _Biomart_ tool which is similar to UCSC Table browser, can
...
Genome browser contain lots of auxiliary high-throughput data. However, there are
...
associated with a publication should be deposited to public archieves. There 
...
that is dedicated to certain genome biology or disease related problems and 
they maintain their own databases and provide access to processed and raw data.
Some of these consortia is mentioned below.
