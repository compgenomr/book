...
knitr::include_graphics("Variance-bias.png" )
```
...
knitr::include_graphics("knnDecisionBoundPCA.png" )
```
...
knitr::include_graphics("ml-random-forest-features.png" )
```
