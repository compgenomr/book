...
```{r sample-clustering.GenomicAlignments, warnings=FALSE, message=FALSE}
...
```{r, rgadem.library, include=TRUE, eval=TRUE, echo=FALSE}
...
**rGADEM** [@rGADEM] package contains a convenient **plot** function for
motif visualization.

We will use the plot function to visualize the most enriched DNA motif:

```{r motif-discovery.seqlogo}
