...
Package names are in bold text (e.g., **methylKit**), and inline code and file names are formatted in a typewriter font. Function names are followed by parentheses (e.g., `genomation::ScoreMatrix()`). The double-colon operator `::` means accessing an object from a package.
