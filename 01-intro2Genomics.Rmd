...
In summary HT techniques have the following steps, and are also summarized in
...
If there is a reference genome available, the reads are aligned to the reference and based
