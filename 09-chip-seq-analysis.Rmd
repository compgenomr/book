...
From \@ref(processingReads) you should be familiar with \@ref(read filtering)
\@ref(read mapping), the concept of multi-mapping reads, 
and the following file formats \@ref(bed), \@ref(gtf), \@ref(wig)
\@ref(bigWig), \@ref(bam). You should also know what PCR is, what
are PCR duplicates, positive and negative strand, and technical and biological 
replicates.
