...
```{r,gintsum,fig.cap="Summary of genomic intervals with different kinds of information",fig.align = 'center',out.width='100%',echo=FALSE}
knitr::include_graphics("GenomicIntervals_data/nonR_Figures/genomeIntervalSummary.png" )
```
...
knitr::include_graphics("GenomicIntervals_data/nonR_Figures/Rle_demo.png" )
```
...
knitr::include_graphics("GenomicIntervals_data/nonR_Figures/Summarized.Experiment.svg" )
```
...
#### subsetting
Subsetting is easy using `[ ]` notation. This can be 
```{r,subsetSe1}
# subset the first five transcripts and first three samples
se[1:5, 1:3]
```

One can also use colu
```{r,subsetSe2}
colData(se)
