...
kable(goResults[order(goResults$p.value), c(3:4, 7, 10, 12)][1:10,])
```
...
```{r gsea_post_1}
kable(gseaResults$greater, caption = 'Up-regulation statistics')
```

```{r gsea_post_2}
kable(gseaResults$less, caption = 'Down-regulation statistics')
```
