...
packagesNeed <- c('qvalue','plot3D','ggplot2','pheatmap',
...
packagesRealNeed <- setdiff(packagesNeed, installed.packages())
if(length(packagesRealNeed)>0){
    cat(sprintf("\nInstalling required packages:\n%s\n", paste0(packToInst, collapse = "\n")))
    BiocManager::install(packagesRealNeed)
}
```
