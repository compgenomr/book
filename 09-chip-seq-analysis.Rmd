...
```{r sample_clustering.complex_heatmap}
# load ComplexHeatmap
...
```{r peak_calling.sharp.plot, message = FALSE, erroe=FALSE}
library(ggplot2)
...
```{r peak_calling.sharp.peak_calling.plot}
library(ggplot2)
