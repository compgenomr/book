...
Firstly, we will install the Bioconductor package manager **BiocManager**

```{r BiocManager, eval=FALSE, echo = TRUE, include=TRUE}
install.packages(BiocManager)
```

Using **BiocManager** we can install rest of the dependencies: 
