...
mydata <- data.frame(chr,start,end,strand) # create data frame
names(mydata) <- c("chr","start","end","strand") # change column names
mydata 
mydata <- data.frame(chr=chr,start=start,end=end,strand=strand) # OR this will work too
mydata
```
