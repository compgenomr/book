...
Protein-DNA interactions control large part of the gene expression regulation. Proteins such as transcription factors as well as histones are directly related to how much and in which contexts are the genes expressed. Some of these concepts are already introduced in Chapter \@ref(intro), if readers need more in depth introduction to these concepts. In this chapter, we will introduce how to process and analyze ChIP-seq data in order to identify genome-wide protein binding sites and learn about underlying sequence context via DNA binding motifs.
