...
```{r sample-clustering.GenomicAlignments}
...
```{r genome-browser-gviz-show, fig.cap='ChIP-seq signal visualized as a browser track using Gviz', width=6, height = 3}
...
Figure\@ref(fig:gc.tidy) compares the GC content dependency on the CPM between
...
If a read overlaps a TSS and an intron, it will be annotates as TSS 
...
```{r peak-quality.scan.show, include=TRUE, echo=FALSE, eval=TRUE}
head(seq)
```
