...
<div class="figure" style="text-align: center">
<img src="10-bs-seq-analysis_files/figure-html/segplot-1.png" alt="Scatter plot of segment mean, methylation values versus segment length. Each dot is a segment identified by the `methSeg()` function." width="55%" />
<p class="caption">(\#fig:segplot)Scatter plot of segment mean, methylation values versus segment length. Each dot is a segment identified by the `methSeg()` function.</p>
</div>
