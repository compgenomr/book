...
```{r, predictAge, fig.width=4.5,out.width='60%', fig.cap="Observed vs predicted age (Left). Residual plot showing for older people the error increases (Right)"}
