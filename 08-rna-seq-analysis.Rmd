...
3. Advanced: 
  ...
  - Use [tsne package](https://cran.r-project.org/web/packages/tsne/tsne.pdf) to draw a t-SNE plot of the expression values. Color the points by sample group. Compare the results with the PCA plots. 
